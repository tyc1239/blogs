    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="/admin/nativeadd"> 添加内容</a> </li>
            ...
            @foreach($res as $k=>$v)
                <tr>
                    ...
                    <td><div class="button-group">
                            <a class="button border-main" href="{{route('edittest',['n_id'=>$v->n_id])}}"><span class="icon-edit"></span> 修改</a>
                            <a class="button border-red" href="nativedel?n_id={{$v->n_id}}" onclick="return del(1,
                            1,1)">
